export const routes = {
    ...
    product: {
        html: "/html/product_details.html",
        js: "/js/pages/product_details.js",
    },
    cart: {
        html: "/html/cart.html",
        js: "/js/pages/cart.js",
    ...
    chatbot: {
        html: "/html/chatbot.html",
        js: "/js/pages/chatbot.js",
    },
    login: {
    ...
    profile: {
        html: "/html/my_account.html",
        js: "/js/pages/my_account.js",
    },
    about: {
